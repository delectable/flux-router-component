...
var TYPE_PUSHMODAL = 'pushmodal';
var TYPE_PAGELOAD = 'pageload';
var TYPE_POPSTATE = 'popstate';
var TYPE_REPLACEMODAL = 'replacemodal';
...
RouterMixin = {
    ...
    componentDidUpdate: function (prevProps, prevState) {
        ...
        var historyState;
        var resetScroll = !nav || nav.resetScroll !== false;
        var pageTitle;
        ...
        switch (navType) {
            ...
            case TYPE_DEFAULT:
                ...
                if (this._enableScroll && resetScroll) {
                    window.scrollTo(0, 0);
            ...
            case TYPE_REPLACESTATE:
                ...
                this._history.replaceState(historyState, null, newState.route.url);
                break;
            case TYPE_REPLACEMODAL:
                historyState = {params: (nav && nav.params) || {}};
                this._history.replaceState(historyState, null, newState.route.url);
                break;
        }
